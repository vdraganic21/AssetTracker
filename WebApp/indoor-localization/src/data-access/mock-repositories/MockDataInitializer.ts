...
export class MockDataInitializer {
    static initializeData(): void {
        ...
        FacilityService.Add(new Facility(1, "Warehouse 1", floorMapDemo, [new Asset(1, "Forklift", 1, new Point(100,100), true), new Asset(2, "Crate 47", 1, new Point(400,500), true)], [new Zone(5, "Office entrances", [new Point(560,150), new Point(740,150), new Point(740,300), new Point(560,300)], 2)]));
        FacilityService.Add(new Facility(2, "Warehouse 35", floorMapDemo, [new Asset(3, "Robot Dog", 2, new Point(200,300), true)], [new Zone(2, "Storage Area NW", [new Point(25,750), new Point(525,750), new Point(525,1275), new Point(25,1275)], 2)]));
        FacilityService.Add(new Facility(3, "Production Line", floorMapDemo, [], [new Zone(4, "Outbound area", [new Point(1200,400), new Point(1500,400), new Point(1500,550), new Point(1200,550)], 2)]));

...
-- Delete data in reverse dependency order to handle foreign key constraints
DELETE FROM assetZoneHistory;
DELETE FROM assetPositionHistory;
DELETE FROM zones;
DELETE FROM assets;
DELETE FROM floorMaps;

SELECT setval(pg_get_serial_sequence('assetZoneHistory', 'id'), 1, false);
